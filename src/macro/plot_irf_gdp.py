...
IRF_PATH    = os.path.join(SCRIPT_DIR, "../../result/macro/gdp/lp_gdp_irf.csv")
OUTPUT_PATH = os.path.join(SCRIPT_DIR, "../../result/macro/gdp/lp_gdp_irf.pdf")
...
def plot_irf(irf_path: str, output_path: str) -> None:
    ...
    ax.set_ylabel("Response of log GDP\n(cumulative from t−1)", fontsize=11)
    ax.set_title("IRF: Oil Supply News Shock → GDP", fontsize=13, fontweight="medium")
    ax.set_xlim(h[0], h[-1])
