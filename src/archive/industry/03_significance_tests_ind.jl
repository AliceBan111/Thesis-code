...
# include("02_lp_estimation_ind_income.jl")
# include("02_lp_estimation_ind_hourlyrate.jl")
# include("02_lp_estimation_ind_hours.jl")
include("02_lp_estimation_ind_unemployment.jl")
# include("02_lp_estimation_ind_inequality.jl")
# include("02_lp_estimation_ind_median.jl")
# include("02_lp_estimation_ind_income_share.jl")
...
function build_significance_table(irfs::Dict{Int, DataFrame},
    ...
    for g in 1:13   
        ...
        if !isempty(θ_full)
            ...
            peak_h    = full_sub.horizon[peak_idx]
            peak_θ    = full_sub.beta_abs[peak_idx]   # ← 改为绝对响应
            peak_bse  = full_sub.boot_se[peak_idx]
        else
