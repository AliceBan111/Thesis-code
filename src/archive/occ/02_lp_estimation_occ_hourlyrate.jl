...
include("../data/data_prep_occ_hourlyrate.jl")   # H_MAX, L_LAG, OCC_LABELS, OUTPUT_DIR
...
function build_col_lists!(df_h::DataFrame)
    ...
    cell_cols  = [:log_rincome, :age_mean, :female_share, :married_share, :hours_mean, :unemp_rate]
