...
const OUTPUT_DIR = joinpath(@__DIR__, "../..", "result", "occ")
mkpath(OUTPUT_DIR)

const CPS_FILE_ID  = "1ksgL6xRyU9BZ9GaoQ8odl-h35BKUITOU"
const CPS_SHA256   = "DE8D97FDDBEB7BB42A35170408F4098A6AF1C6CDB1F64FEDE2A93B8D23F93D4C"
const CPS_PATH     = joinpath(DATA_DIR, "cps_00013.dat")
...
function parse_cps(path::String)::DataFrame
    ...
    open(path, "r") do f
        for line in eachline(f)
            ...
            uhrsworkt_str = strip(@view line[30:32])
