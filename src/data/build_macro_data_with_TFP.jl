...
"""
function build_macro_data_with_TFP(start_date::Date, end_date::Date)
    ...
    # 6. TFP
    TFP_data = DataFrame(XLSX.readtable(
        joinpath(@__DIR__, "../../data/quarterly_tfp.xlsx"), "quarterly"; 
        first_row = 2,
        infer_eltypes = true
    ))
    ...
    TFP_filtered = TFP_filtered[(TFP_filtered.observation_date .>= start_date) .&
